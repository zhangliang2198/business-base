...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.zhen777.www";
    private static final String ARTIFACT_ID = "gaia";
    private static final String PACKAGE_NAME = "com.zhen777.gaia";
    private static final String TITLE = "gaia base system";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.zhen777.www";
        String artifactIdNew = "gaia";
        String packageNameNew = "com.zhen777.gaia";
        String titleNew = "gaia base system";
