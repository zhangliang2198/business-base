package com.zhen777.gaia.module.system.service.social;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.lang.Assert;
import com.zhen777.gaia.framework.common.util.http.HttpUtils;
import com.zhen777.gaia.framework.social.core.GaiaAuthRequestFactory;
...
import com.zhen777.gaia.module.system.dal.mysql.social.SocialUserBindMapper;
import com.zhen777.gaia.module.system.dal.mysql.social.SocialUserMapper;
...
public class SocialUserServiceImpl implements SocialUserService {
    ...
    @Resource// 由于自定义了 GaiaAuthRequestFactory 无法覆盖默认的 AuthRequestFactory，所以只能注入它
    private GaiaAuthRequestFactory gaiaAuthRequestFactory;
    ...
    public String getAuthorizeUrl(Integer type, String redirectUri) {
        ...
        AuthRequest authRequest = gaiaAuthRequestFactory.get(SocialTypeEnum.valueOfType(type).getSource());
        // 生成跳转地址
