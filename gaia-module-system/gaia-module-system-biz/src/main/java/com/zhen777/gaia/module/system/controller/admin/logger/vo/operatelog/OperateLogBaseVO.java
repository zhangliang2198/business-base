package com.zhen777.gaia.module.system.controller.admin.logger.vo.operatelog;
...
public class OperateLogBaseVO {
    ...
    @Schema(description = "Java 方法名", required = true, example = "com.zhen777.gaia.adminserver.UserController.save(...)")
