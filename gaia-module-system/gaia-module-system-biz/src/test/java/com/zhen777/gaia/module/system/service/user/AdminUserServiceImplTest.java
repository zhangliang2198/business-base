package com.zhen777.gaia.module.system.service.user;
...
import com.zhen777.gaia.module.infra.api.file.FileApi;
...
import com.zhen777.gaia.module.system.controller.admin.user.vo.user.*;
...
import com.zhen777.gaia.module.system.dal.dataobject.dept.UserPostDO;
...
import com.zhen777.gaia.module.system.dal.mysql.dept.UserPostMapper;
import com.zhen777.gaia.module.system.dal.mysql.user.AdminUserMapper;
import com.zhen777.gaia.module.system.enums.common.SexEnum;
...
import com.zhen777.gaia.module.system.service.tenant.TenantService;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("gaiayuanma");
        ...
        assertEquals("gaiayuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("gaiayuanma"))).thenReturn("java");
