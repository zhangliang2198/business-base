...
* 演示地址：<http://dashboard.gaia.iocoder.cn>
...
| `gaia-cloud`      | Spring Cloud 微服务       | **[Gitee](https://gitee.com/zhijiantianya/gaia-cloud)** &nbsp;&nbsp;&nbsp; [Github](https://github.com/YunaiV/gaia-cloud)        |
| `Spring-Boot-Labs` | Spring Boot & Cloud 入门 | **[Gitee](https://gitee.com/gaiacode/SpringBoot-Labs)** &nbsp;&nbsp;&nbsp; [Github](https://github.com/gaiacode/SpringBoot-Labs) |
...
| 项目                                                                       | 说明                 |
|--------------------------------------------------------------------------|--------------------|
| `gaia-dependencies`                                                     | Maven 依赖版本管理       |
| `gaia-framework`                                                        | Java 框架拓展          |
| `gaia-server`                                                           | 管理后台 + 用户 APP 的服务端 |
| `gaia-module-system`                                                    | 系统功能的 Module 模块    |
| `gaia-module-member`                                                    | 会员中心的 Module 模块    |
| `gaia-module-infra`                                                     | 基础设施的 Module 模块    |
| `gaia-module-bpm`                                                       | 工作流程的 Module 模块    |
| `gaia-module-pay`                                                       | 支付系统的 Module 模块    |
| `gaia-module-mall`                                                      | 商城系统的 Module 模块    |
| `gaia-module-mp`                                                        | 微信公众号的 Module 模块   |
| `gaia-module-report`                                                    | 大屏报表 Module 模块     |

> 前端项目的地址：
> 
> * [`gaia-ui-admin-vue3`](https://gitee.com/gaiacode/gaia-ui-admin-vue3)：基于 Vue3 + element-plus 实现的管理后台
> * `gaia-ui-admin`：基于 Vue2 + element-ui 实现的管理后台
> * [`gaia-ui-go-view`](https://gitee.com/gaiacode/gaia-ui-go-view)：基于 Vue3 + naive-ui 实现的大屏报表
> * `gaia-ui-admin-uniapp`：基于 uni-app + uni-ui 实现的管理后台的小程序 
> * `gaia-ui-app`：基于 uni-app + uview 实现的用户 App
...
| [Druid](https://github.com/alibaba/druid)                                                   | JDBC 连接池、监控组件    | 1.2.15      | [文档](http://www.iocoder.cn/Spring-Boot/datasource-pool/?gaia) |
| [MyBatis Plus](https://mp.baomidou.com/)                                                    | MyBatis 增强工具包    | 3.5.3.1     | [文档](http://www.iocoder.cn/Spring-Boot/MyBatis/?gaia)         |
| [Dynamic Datasource](https://dynamic-datasource.com/)                                       | 动态数据源            | 3.6.1       | [文档](http://www.iocoder.cn/Spring-Boot/datasource-pool/?gaia) |
| [Redis](https://redis.io/)                                                                  | key-value 数据库    | 5.0 / 6.0   |                                                                |
| [Redisson](https://github.com/redisson/redisson)                                            | Redis 客户端        | 3.18.0      | [文档](http://www.iocoder.cn/Spring-Boot/Redis/?gaia)           |
| [Spring MVC](https://github.com/spring-projects/spring-framework/tree/master/spring-webmvc) | MVC 框架           | 5.3.24      | [文档](http://www.iocoder.cn/SpringMVC/MVC/?gaia)               |
| [Spring Security](https://github.com/spring-projects/spring-security)                       | Spring 安全框架      | 5.7.6       | [文档](http://www.iocoder.cn/Spring-Boot/Spring-Security/?gaia) |
| [Hibernate Validator](https://github.com/hibernate/hibernate-validator)                     | 参数校验组件           | 6.2.5       | [文档](http://www.iocoder.cn/Spring-Boot/Validation/?gaia)      |
| [Flowable](https://github.com/flowable/flowable-engine)                                     | 工作流引擎            | 6.8.0       | [文档](https://doc.iocoder.cn/bpm/)                              |
| [Quartz](https://github.com/quartz-scheduler)                                               | 任务调度组件           | 2.3.2       | [文档](http://www.iocoder.cn/Spring-Boot/Job/?gaia)             |
| [Knife4j](https://gitee.com/xiaoym/knife4j)                                                 | Swagger 增强 UI 实现 | 4.0.0       | [文档](http://www.iocoder.cn/Spring-Boot/Swagger/?gaia)         |
| [Resilience4j](https://github.com/resilience4j/resilience4j)                                | 服务保障组件           | 1.7.1       | [文档](http://www.iocoder.cn/Spring-Boot/Resilience4j/?gaia)    |
| [SkyWalking](https://skywalking.apache.org/)                                                | 分布式应用追踪系统        | 8.12.0      | [文档](http://www.iocoder.cn/Spring-Boot/SkyWalking/?gaia)      |
| [Spring Boot Admin](https://github.com/codecentric/spring-boot-admin)                       | Spring Boot 监控平台 | 2.7.10      | [文档](http://www.iocoder.cn/Spring-Boot/Admin/?gaia)           |
| [Jackson](https://github.com/FasterXML/jackson)                                             | JSON 工具库         | 2.13.3      |                                                                |
| [MapStruct](https://mapstruct.org/)                                                         | Java Bean 转换     | 1.5.3.Final | [文档](http://www.iocoder.cn/Spring-Boot/MapStruct/?gaia)       |
| [Lombok](https://projectlombok.org/)                                                        | 消除冗长的 Java 代码    | 1.18.24     | [文档](http://www.iocoder.cn/Spring-Boot/Lombok/?gaia)          |
| [JUnit](https://junit.org/junit5/)                                                          | Java 单元测试框架      | 5.8.2       | -                                                              |
| [Mockito](https://github.com/mockito/mockito)                                               | Java Mock 框架     | 4.8.0       | -                                                              |

### [管理后台 Vue2 前端](./gaia-ui-admin)
...
### [管理后台 uni-app 跨端](./gaia-ui-admin-uniapp)
