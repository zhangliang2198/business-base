...
import com.zhen777.gaia.framework.tracer.core.aop.BizTraceAspect;
import com.zhen777.gaia.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "gaia.tracer", value = "enable", matchIfMissing = true)
public class GaiaTracerAutoConfiguration {
