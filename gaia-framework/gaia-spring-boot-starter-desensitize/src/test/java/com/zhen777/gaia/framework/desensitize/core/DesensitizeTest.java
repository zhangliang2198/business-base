package com.zhen777.gaia.framework.desensitize.core;

import com.zhen777.gaia.framework.common.util.json.JsonUtils;
import com.zhen777.gaia.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.zhen777.gaia.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.zhen777.gaia.framework.desensitize.core.annotation.Address;
import com.zhen777.gaia.framework.desensitize.core.slider.annotation.BankCardDesensitize;
import com.zhen777.gaia.framework.desensitize.core.slider.annotation.CarLicenseDesensitize;
import com.zhen777.gaia.framework.desensitize.core.slider.annotation.ChineseNameDesensitize;
import com.zhen777.gaia.framework.desensitize.core.slider.annotation.FixedPhoneDesensitize;
import com.zhen777.gaia.framework.desensitize.core.slider.annotation.IdCardDesensitize;
import com.zhen777.gaia.framework.desensitize.core.slider.annotation.PasswordDesensitize;
import com.zhen777.gaia.framework.desensitize.core.slider.annotation.MobileDesensitize;
import com.zhen777.gaia.framework.desensitize.core.slider.annotation.SliderDesensitize;
