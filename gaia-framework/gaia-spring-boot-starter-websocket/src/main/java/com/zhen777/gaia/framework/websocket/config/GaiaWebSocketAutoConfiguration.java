 ...
 */
@AutoConfiguration
// 允许使用 gaia.websocket.enable=false 禁用websocket
@ConditionalOnProperty(prefix = "gaia.websocket", value = "enable", matchIfMissing = true)
@EnableConfigurationProperties(WebSocketProperties.class)
public class GaiaWebSocketAutoConfiguration {
    @Bean
