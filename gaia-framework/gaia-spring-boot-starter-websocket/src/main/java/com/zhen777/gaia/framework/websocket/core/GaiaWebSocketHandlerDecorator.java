package com.zhen777.gaia.framework.websocket.core;
...
public class GaiaWebSocketHandlerDecorator extends WebSocketHandlerDecorator {
    public GaiaWebSocketHandlerDecorator(WebSocketHandler delegate) {
        super(delegate);
    }
