...
import com.zhen777.gaia.module.promotion.convert.price.PriceConvert;
...
import static com.zhen777.gaia.framework.common.util.collection.CollectionUtils.getSumValue;
...
//                            .setMeetTip(String.format("差 %s 元可用优惠劵", formatPrice(coupon.getUsePrice() - originPrice)));
     ...
     * 计算商品级别的价格，例如说：
     * 1. 会员折扣
     * 2. 限时折扣 {@link com.zhen777.gaia.module.promotion.dal.dataobject.discount.DiscountActivityDO}
     *
     * 其中，会员折扣、限时折扣取最低价
     *
     * @param userId 用户编号
    ...
    /**
     * 计算订单级别的价格，例如说：
     * 1. 满减送 {@link com.zhen777.gaia.module.promotion.dal.dataobject.reward.RewardActivityDO}
     *
     * @param userId 用户编号
     * @param priceCalculate 价格计算的结果
     */
