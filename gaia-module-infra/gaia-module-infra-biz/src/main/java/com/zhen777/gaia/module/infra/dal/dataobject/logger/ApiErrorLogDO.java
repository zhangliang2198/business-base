package com.zhen777.gaia.module.infra.dal.dataobject.logger;
...
public class ApiErrorLogDO extends BaseDO {
     ...
     * 处理用户编号
     *
     * 关联 com.zhen777.gaia.adminserver.modules.system.dal.dataobject.user.SysUserDO.SysUserDO#getId()
     */
